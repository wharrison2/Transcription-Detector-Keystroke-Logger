...
plt.legend()
plt.show()
print("automatically selected custom_choice")
print(f"custom: {tester.get_avg_performance_logistic(features=feature_choice, show_plot=False)}\nbaseline {tester.get_avg_performance_logistic(show_plot=False)}")
print(f"custom: {tester.get_avg_performance_neural(features=feature_choice, show_plot=False)}\nbaseline {tester.get_avg_performance_neural(show_plot=False)}")
print(f"custom: {tester.get_avg_performance_xg(features=feature_choice, show_plot=False)}\nbaseline {tester.get_avg_performance_xg(show_plot=False)}")

print("\nMy custom choice")
custom_feature_choice=my_custom_feature_choice
...
print("\nMinimal choice")
custom_feature_choice=['proportion_spent_paused', 'deletion_rate']
print(f"custom: {tester.get_avg_performance_logistic(features=custom_feature_choice, show_plot=False)}\nbaseline {tester.get_avg_performance_logistic(show_plot=False)}")
print(f"custom: {tester.get_avg_performance_neural(features=custom_feature_choice, show_plot=False)}\nbaseline {tester.get_avg_performance_neural(show_plot=False)}")
print(f"custom: {tester.get_avg_performance_xg(features=custom_feature_choice, show_plot=False)}\nbaseline {tester.get_avg_performance_xg(show_plot=False)}")
...
train_data = normalize_features(extract_features(train_tasks, features=feature_choice))
test_data = extract_features(test_tasks, features=feature_choice)
